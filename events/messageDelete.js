...
module.exports = {
  ...
  async execute(message) {
    if (message.channel.id === message.client.config.countChannel) {
      ...
      var lastmsg = (await message.channel.messages.fetch({ limit: 1 })).first();
          ...
          embeds: [
            {
              ...
              description: `Please continue from **${currentCount + 1}**!\nLast count was by <@!${await message.client.db.get("leader")}>.`,
              color: 0xff0000
            }
          ]
        })
